...
public class ClasspathBuilderTest {
	...
	public void oneDependency() {
		assertThat(classpathBuilder(dependency("myGroup", "myArtifact", "1.0.0")).build(),
			is(ROOT_PATH + FILE_SEP + "myGroup" + FILE_SEP + "myArtifact" + FILE_SEP + "1.0.0"
					+ FILE_SEP + "myArtifact-1.0.0.jar"));
	}
	...
	public void oneDependencyWithNestedGroupId() {
		assertThat(classpathBuilder(dependency("my.Group.id-test", "myArtifact", "1.0.0")).build(),
			is(ROOT_PATH + FILE_SEP + "my" + FILE_SEP + "Group" + FILE_SEP + "id-test"
				+ FILE_SEP + "myArtifact" + FILE_SEP + "1.0.0" + FILE_SEP + "myArtifact-1.0.0.jar"));
	}

	@Test
	public void oneDependencyWithOtherTypeThanJar() {
		assertThat(classpathBuilder(dependency("myGroup", "myArtifact", "1.0.0", "war")).build(),
			is(ROOT_PATH + FILE_SEP + "myGroup" + FILE_SEP + "myArtifact" + FILE_SEP + "1.0.0"
					+ FILE_SEP + "myArtifact-" + "1.0.0.war"));
	}
	...
	public void manyDependenciesWithNestedGroupIdsAndManyTypes() {
		...
		final String expectedPath = ROOT_PATH + FILE_SEP
				+ "myGroup" + FILE_SEP + "myArtifact" + FILE_SEP + "1.0.0" + FILE_SEP + "myArtifact-1.0.0.war"
				+ PATH_SEP + ROOT_PATH + FILE_SEP
				+ "secondGroup" + FILE_SEP + "test" + FILE_SEP + "dummy-jar" + FILE_SEP + "10.2.3-SNAPSHOT"
						+ FILE_SEP + "dummy-jar-10.2.3-SNAPSHOT.jar"
				+ PATH_SEP + ROOT_PATH + FILE_SEP
				+ "biggest" + FILE_SEP + "company" + FILE_SEP + "of" + FILE_SEP + "world"
						+ FILE_SEP + "big-web-app" + FILE_SEP + "1.0.0" + FILE_SEP + "big-web-app-1.0.0.ear";
	...
	public void rootPathWithTrailingFileSeparator() {
		final List<Dependency> dependencies = Arrays.asList(new Dependency[] { dependency("myGroup", "myArtifact", "1.0.0") });
		assertThat(new ClasspathBuilder(ROOT_PATH + FILE_SEP, dependencies).build(),
			is(ROOT_PATH + FILE_SEP + "myGroup" + FILE_SEP + "myArtifact" + FILE_SEP + "1.0.0"
					+ FILE_SEP + "myArtifact-" + "1.0.0.jar"));
	}
